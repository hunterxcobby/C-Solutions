...
/**
 * romanToInt - to convert roman numerals to integer
 *
 * @s: a string containing the roman values
 * Return: total value
 */
...
/**
 * getValue - get the integer value of
 * the roman numeral
 *
 * @c: the integer
 * Return: the integer or 0 for unknown characters
 */
